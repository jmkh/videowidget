...
function isMyAndroid() {
    if(typeof window.testKorobok !="undefined") return true;
...
function Wrapper(container) {
    ...
    this.render = function (size, pos) {
        ...
        wrapper.style.background = "#000000 url('//apptoday.ru/autogit/autostop/img/yt-loader.gif') 50% 50% no-repeat";
    ...
    function insertFrame() {
        ...
        if (isMyAndroid()) {
            self.frame.src = "//video.apptoday.ru/autogit/autostop/android.html?index=" + self.index;
        } else {
            self.frame.style.display = "none";
            self.frame.src = "//video.apptoday.ru/autogit/autostop/desctop.html?index=" + self.index;
		...
		if(typeof window.testKorobok!="undefined"){
		self.frame.src+='&testframe=1'
		}
