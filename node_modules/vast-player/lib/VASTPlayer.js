...
var ProxyFrameVPAID = require('./players/ProxyFrameVPAID');
...
VASTPlayer.prototype.load = function load(uri) {
    ...
    return VAST.fetch(uri, config).then(function loadPlayer(vast) {
        ...
        var config = (function() {
            ...
            var ProxyFrameVPAIDFiles = vast.filter('ads[0].creatives[0].mediaFiles', function(mediaFile) {
                ...
                return (
                        ...
                        mediaFile.type === 'application/proxyframe'
                    ) && mediaFile.apiFramework === 'VPAID';
            });
            ...
            switch (true){
                case (jsVPAIDFiles.length > 0):
                    ...
                    break;
                //case (ProxyFrameVPAIDFiles.length > 0):
                //    self.pType=5;
                //    return {
                //        player: new ProxyFrameVPAID(self.container),
                //        mediaFiles: ProxyFrameVPAIDFiles
                //    };
                //    break;
                case (swfVPAIDFiles.length > 0):
                    self.pType=2;
